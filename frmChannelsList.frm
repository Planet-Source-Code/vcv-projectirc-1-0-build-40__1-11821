...
Private Sub lvChannels_BeforeLabelEdit(Cancel As Integer)

End Sub

Private Sub lvChannels_Click()
...
Private Sub lvChannels_ItemClick(ByVal Item As MSComctlLib.ListItem)
